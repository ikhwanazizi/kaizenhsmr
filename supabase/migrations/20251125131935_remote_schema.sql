...
ALTER FUNCTION "public"."get_remaining_daily_email_quota"() OWNER TO "postgres";
...
DECLARE
    ...
    deleted_count INT;
BEGIN
    -- Get the retention period from the system_settings table
    SELECT (value::jsonb->>0)::INT INTO retention_days
    FROM public.system_settings
    WHERE key = 'audit_log_retention_days'
    LIMIT 1;

    -- If retention_days is NULL, 0, or negative, do nothing (Keep Forever)
...
ALTER FUNCTION "public"."prune_admin_audit_logs"() OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."email_send_log" (
    ...
    "error_message" "text",
    CONSTRAINT "email_send_log_email_type_check" CHECK (("email_type" = ANY (ARRAY['contact_reply'::"text", 'subscriber_verification'::"text"]))),
...
CREATE TABLE IF NOT EXISTS "public"."post_blocks" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"(),
    "updated_at" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "post_blocks_type_check" CHECK (("type" = ANY (ARRAY['heading'::"text", 'paragraph'::"text", 'image'::"text", 'video'::"text", 'code'::"text", 'quote'::"text", 'divider'::"text", 'list'::"text", 'table'::"text"])))
);
...
GRANT ALL ON FUNCTION "public"."get_remaining_daily_email_quota"() TO "anon";
GRANT ALL ON FUNCTION "public"."get_remaining_daily_email_quota"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_remaining_daily_email_quota"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."prune_admin_audit_logs"() TO "anon";
GRANT ALL ON FUNCTION "public"."prune_admin_audit_logs"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."prune_admin_audit_logs"() TO "service_role";
