...
export default function BlogPostLayout({ slug, category }: { slug: string; category: "blog" | "development" }) {
  ...
  const generateTOC = () => {
    ...
    blocks.forEach((block) => {
      if (block.type === "heading" && (block.content.level === 2 || block.content.level === 3)) {
        headings.push({
          id: `heading-${block.id}`,
    ...
    return (
      <div className="min-h-screen bg-white">
        ...
        <div className="max-w-4xl mx-auto px-4 py-20 text-center">
          ...
          <a href={category === "blog" ? "/resources/blog-articles" : "/company/developments"} className="text-[#008080] hover:underline">
    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="grid md:grid-cols-5 gap-0">
            ...
            <div className="md:col-span-2 bg-white p-6 md:p-8 flex flex-col justify-center">
              ...
              <div className="flex items-center text-gray-600">
                <span>By {post.author?.full_name || post.author?.email || "KaizenHR Team"}</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-12">
        <div className="flex flex-col lg:flex-row gap-12">
          <aside className="lg:w-2/5 lg:sticky lg:top-24 lg:self-start order-2 lg:order-1" style={{ maxHeight: "calc(100vh - 120px)" }}>
            <StickySidebar toc={toc} activeSection={activeSection} postTitle={post.title} />
          </aside>
