// src/app/(public)/developments/[slug]/page.tsx
      ...
      <main className="flex-grow pt-16">
        <article>
          ...
          <Container className="py-12">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="mb-4 flex items-center gap-3">
                ...
                {metadata.version && (
                  <span className="inline-block px-3 py-1 text-sm font-semibold text-gray-600 bg-gray-100 rounded-full">
                    v{metadata.version}
                  </span>
                )}
              </div>
              ...
              <div className="flex items-center gap-4 text-sm text-gray-500 pb-6 border-b border-gray-200">
                ...
                {metadata.release_date && (
                  <>
                    <span>•</span>
                    <div>Released: {metadata.release_date}</div>
                  </>
                )}
              </div>
            </div>
          ...
          <Container className="py-8">
            <div className="max-w-4xl mx-auto prose prose-lg prose-purple max-w-none">
              {blocks.map((block) => {
                ...
                switch (block.type) {
                  ...
                  case "quote":
                    return (
                      <blockquote key={block.id} className="border-l-4 border-purple-500 pl-4 py-2 my-6 italic text-xl text-gray-700">
                        <p>{content.text}</p>
                        {content.author && (
        ...
        node.marks.forEach((mark: any) => {
          switch (mark.type) {
            ...
            case "strike":
              ...
              break;
            case "link":
              text = `<a href="${mark.attrs.href}" class="text-purple-600 underline">${text}</a>`;
              break;
            case "highlight":
              text = `<mark>${text}</mark>`;
              break;
